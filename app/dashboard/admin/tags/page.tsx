          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-300">
                Remember that changing tag scores or deactivating tags will not
                affect risk scores on items where those tags have already been
                applied. Risk scores are calculated at the time of item
                creation. To recalculate existing items, reviwers or adming must
                manually recalculate risk calculation on items.
              </p>
            </div>
          </div>
        </div>
